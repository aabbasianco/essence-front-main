...
const buttonDefaults: DefaultStatesRecipe<ButtonResolvedApiProps> = {
  default: {
    appearance: "solid",
    tone: "primary",
    shape: "rounded",
...
const buttonPresetRecipe: ComponentPresetsRecipe<ButtonResolvedApiProps> = {
  primary: {
    default: {
      ...
      shape: "rounded",
      size: "lg",
      startIcon: buttonDefaults.default.startIcon,
      endIcon: buttonDefaults.default.endIcon,
      isIcon: buttonDefaults.default.isIcon,
    },
    hover: {},
    pressed: {},
  },
  ...
  secondary: {
    default: {
      ...
      tone: "primary",
      shape: buttonDefaults.default.shape,
      size: buttonDefaults.default.size,
      startIcon: buttonDefaults.default.startIcon,
      endIcon: buttonDefaults.default.endIcon,
      isIcon: buttonDefaults.default.isIcon,
    },
  ...
  tertiary: {
    ...
    hover: {
      appearance: "ghost-outline",
      tone: "secondary",
      shape: buttonDefaults.hover?.shape ?? buttonDefaults.default.shape,
      size: buttonDefaults.hover?.size ?? buttonDefaults.default.size,
      startIcon:
        buttonDefaults.hover?.startIcon ?? buttonDefaults.default.startIcon,
      endIcon: buttonDefaults.hover?.endIcon ?? buttonDefaults.default.endIcon,
      isIcon: buttonDefaults.hover?.isIcon ?? buttonDefaults.default.isIcon,
    },
  },
